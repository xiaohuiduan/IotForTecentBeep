...
![](imgs/image-20210110160709316.png)
...
![](imgs/image-20210111001159601.png)
...
![](imgs/image-20210110204928555.png)
...
![](imgs/image-20210110162327104.png)
...
![](imgs/image-20210110163410393.png)
...
![](imgs/image-20210110163600417.png)
...
![](imgs/image-20210110164115396.png)
...
![](imgs/image-20210110164635715.png)
...
![](imgs/image-20210110165643637.png)

### 使用设备

点击 **my_pi** ，进入设备管理。

![](imgs/image-20210110165723711.png)
...
![](imgs/image-20210110165755939.png)

### 在线调试

可以使用在线的调试功能对物联网设备进行功能下发。（比如说下发开关数据，控制蜂鸣器的开关）

![](imgs/image-20210110223500195.png)

### 设备日志

可以在设备中看到物联网设备与云平台之间的上行和下行数据。

![](imgs/image-20210110223846544.png)
...
![](imgs/image-20210110172651328.png)
...
![](imgs/image-20210110181811614.png)
...
![](imgs/image-20210110202842411.png)

经过如上的操作我们就将项目编译成了jar包，jar包在target目录下。

![](imgs/image-20210111000936137.png)
...
![](imgs/image-20210111002518889.png)
...
![](imgs/image-20210111003251622.png)

然后打开”腾讯连连“小程序，对二维码进行扫描，即可将设备加入。

![](imgs/image-20210111003736085.png)

点击中间的按钮就可以实现对蜂鸣器的控制了！！！

![](imgs/image-20210111003805707.png)
